	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220726/3c52428414304e9287cacb0f3ea21336.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"40px","margin":"0","borderRadius":"10px","backgroundImage":"url(http://codegen.caihongy.cn/20220726/b38e2eb078c14dfabb040bce55c47c6b.png)","width":"1000px","backgroundSize":"100% 100%","backgroundRepeat":"no-repeat","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 30px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","fontWeight":"600","height":"auto"}' class="title">少儿绘画学习平台注册</div>
				<el-form-item :style='{"width":"40%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xuesheng'">
				...
				<el-form-item :style='{"width":"40%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='jiaoshi'">
