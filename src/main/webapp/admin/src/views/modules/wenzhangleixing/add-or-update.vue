<template>
	<div class="addEdit-block" :style='{"padding":"30px 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="文章类型" prop="wenzhangleixing">
					<el-input v-model="ruleForm.wenzhangleixing" placeholder="文章类型" clearable  :readonly="ro.wenzhangleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="文章类型" prop="wenzhangleixing">
