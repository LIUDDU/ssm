<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0 0 10px","listStyle":"none","margin":"0","position":"relative","background":"#FFF"}' class="el-menu-vertical-demo" default-active="0">
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  white-space: nowrap;
				  				  background-image: url(http://codegen.caihongy.cn/20220726/3bfc79d51460428ca5b1e6b0bdd7f4a8.png);
				  				  position: relative;
				  		}
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						background-size: 100% 100%;
						color: rgba(0, 0, 0, 1);
						background: url(http://codegen.caihongy.cn/20220726/b84a67edae8f479c8a08f44e14f36f96.png);
					}
